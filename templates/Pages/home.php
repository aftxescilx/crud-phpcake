...
<head>
    ...
    <title>
        Instituto Jeffersonian - CakePHP
        <?= $this->fetch('title') ?>
    </title>
    <?= $this->Html->meta('icon') ?>
...
<body>
    <header>
        <div class="container text-center">
            ...
            <h1>
               Base de Datos del Instituto Jeffersonian (🍓)
            </h1>
        </div>
    </header>
    <main class="main">
        <div class="container">
            <div class="content">
                ...
                <hr>
                <h3> Beneficiarios y Donaciones</h3>
                <p>Información referente a las donaciones</p>
                <div class="col-md-2">
                <?= $this->Html->link(__('Beneficiarios'), ['action' => '../Beneficiario'], ['class' => 'button']) ?>
                <!-- </div>
                <div class="col-md-2"> -->
                <?= $this->Html->link(__('Donaciones'), ['action' => '../Donacion'], ['class' => 'button']) ?>
                <!-- </div>
                <div class="col-md-2"> -->
                <?= $this->Html->link(__('Donación-Institución'), ['action' => '../Donacioninstitucion'], ['class' => 'button']) ?>
                </div>
                <!-- <div class="row">
                ...
                <hr>
                <h3>Información referente a los empleados</h3>
                <div class="col-md-2">
                <?= $this->Html->link(__('Empleados'), ['action' => '../Empleado/'], ['class' => 'button']) ?>
                <!-- </div>
                <div class="col-md-2"> -->
                <?= $this->Html->link(__('Empleado-Equipo'), ['action' => '../Empleadoequipo/'], ['class' => 'button']) ?>
                <!-- </div>
                <div class="col-md-2"> -->
                <?= $this->Html->link(__('Certificados'), ['action' => '../Certificado/'], ['class' => 'button']) ?>
                <?= $this->Html->link(__('Instituciones Educativas'), ['action' => '../Institucioneducativa/'], ['class' => 'button']) ?>
                
                <?= $this->Html->link(__('Tipos de Certificados'), ['action' => '../Tipocertificado/'], ['class' => 'button']) ?>
                <?= $this->Html->link(__('Tipos de Empleados'), ['action' => '../Tipoempleado/'], ['class' => 'button']) ?>

                </div>
                <hr>
                <h3>Información referente a los casos</h3>
                <div class="col-md-2">
                <?= $this->Html->link(__('Casos'), ['action' => '../Caso/'], ['class' => 'button']) ?>
                <!-- </div>
                <div class="col-md-2"> -->
                <?= $this->Html->link(__('Equipos'), ['action' => '../Equipo/'], ['class' => 'button']) ?>
                <!-- </div>
                <div class="col-md-2"> -->
                <?= $this->Html->link(__('Reportes'), ['action' => '../Reporte/'], ['class' => 'button']) ?>
                </div>
                <hr>
                <h3>Información referente a los materiales</h3>
                <div class="col-md-2">
                <?= $this->Html->link(__('Instrumentos'), ['action' => '../Instrumento/'], ['class' => 'button']) ?>
                <?= $this->Html->link(__('Tipos de Instrumentos'), ['action' => '../Tipoinstrumento/'], ['class' => 'button']) ?>
                <?= $this->Html->link(__('Mobiliario'), ['action' => '../Mobiliario/'], ['class' => 'button']) ?>
                <?= $this->Html->link(__('Tipos de Mobiliario'), ['action' => '../Tipomobiliario/'], ['class' => 'button']) ?>
                <?= $this->Html->link(__('Reactivos'), ['action' => '../Reactivo/'], ['class' => 'button']) ?>
                </div>
                <hr>
                <h3>Información referente a las visitas</h3>
                <div class="col-md-2">
                <?= $this->Html->link(__('Visitas'), ['action' => '../Visita/'], ['class' => 'button']) ?>
                <?= $this->Html->link(__('Tipos de Visitas'), ['action' => '../Tipovisita/'], ['class' => 'button']) ?>
                <?= $this->Html->link(__('Visitantes'), ['action' => '../Visitante/'], ['class' => 'button']) ?>
                <?= $this->Html->link(__('Pases'), ['action' => '../Pase/'], ['class' => 'button']) ?>
                <?= $this->Html->link(__('Tipos de Pases'), ['action' => '../Tipopase/'], ['class' => 'button']) ?>
                </div>
                <hr>
                <!-- <div class="row">
