...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $instrumento->idInstrumento],
                ['confirm' => __('Are you sure you want to delete # {0}?', $instrumento->idInstrumento), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="instrumento form content">
            ...
            <fieldset>
                <legend><?= __('Edit Instrumento') ?></legend>
                <?php
