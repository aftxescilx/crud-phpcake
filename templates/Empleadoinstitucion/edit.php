...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $empleadoinstitucion->idEmpleadoInstitucion],
                ['confirm' => __('Are you sure you want to delete # {0}?', $empleadoinstitucion->idEmpleadoInstitucion), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="empleadoinstitucion form content">
            ...
            <fieldset>
                <legend><?= __('Edit Empleadoinstitucion') ?></legend>
                <?php
