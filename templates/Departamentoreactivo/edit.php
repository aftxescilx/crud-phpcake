...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $departamentoreactivo->idDepartamentoReactivo],
                ['confirm' => __('Are you sure you want to delete # {0}?', $departamentoreactivo->idDepartamentoReactivo), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="departamentoreactivo form content">
            ...
            <fieldset>
                <legend><?= __('Edit Departamentoreactivo') ?></legend>
                <?php
