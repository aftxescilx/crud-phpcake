...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $institucioneducativa->idInstitucionEducativa],
                ['confirm' => __('Are you sure you want to delete # {0}?', $institucioneducativa->idInstitucionEducativa), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="institucioneducativa form content">
            ...
            <fieldset>
                <legend><?= __('Edit Institucioneducativa') ?></legend>
                <?php
